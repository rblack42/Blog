...
are flying, and how the airplane is oriented relative to the ground, even in the
...
instruments might be in different places in the second one, and you need to
learn where everything is, because they are all important in some way, and you
...
front, and two pedals under my feet, that you could push back and forth.
...
Here is a really good look at one of these, being generated by an F16 fighter
jet:
